...
// export default function NeederDashboard() {
...
//     const user = localStorage.getItem("needer")
//     if (user) {
//       try {
...
//         ...serviceForm,
//         urgency: "normal",
//         imageUrl: uploadedImage ? uploadedImage.name : null,
//       };
//       await createProblem(problemData);
//       alert("✅ Service request submitted successfully!");
//       setShowServiceModal(false);
//       setServiceForm({ title: "", description: "", category: "", urgency: "", budget:"",location: "" });
//     } catch (err) {
//       console.error(err);
...
//     if (uploadedImage) {
//       window.open("https://localfix-bm69dgvxmn5h6ttbamtc95.streamlit.app/", "_blank")
//     } else {
...
//               <input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="What service do you need?" className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300" />
//             </div>
//             <select value={selectedCategory} onChange={(e) => setSelectedCategory(e.target.value)} className="px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300" >
...
//                   <div key={provider.id} className="group p-4 border border-gray-100 rounded-2xl hover:shadow-lg hover:border-blue-200 transition-all duration-300 transform hover:-translate-y-1" >
//                     <div className="flex items-center space-x-4">
//                       <img src={provider.image || "/placeholder.svg"} alt={provider.name} className="w-16 h-16 rounded-xl object-cover group-hover:scale-105 transition-transform" />
//                       <div className="flex-1">
//                         <h3 className="font-semibold text-gray-800 group-hover:text-blue-600 transition-colors"> {provider.name} </h3>
//                         <p className="text-sm text-gray-600 mb-1">{provider.category}</p>
//                         <div className="flex items-center space-x-4 text-sm text-gray-500">
//                           <div className="flex items-center"> <Star className="w-4 h-4 text-yellow-400 mr-1" /> {provider.rating} ({provider.reviews}) </div>
//                           <div className="flex items-center"> <MapPin className="w-4 h-4 mr-1" /> {provider.distance} </div>
//                         </div>
//                       </div>
//                       <div className="text-right">
//                         <p className="font-semibold text-gray-800">{provider.price}</p>
//                         <button className="mt-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"> Contact </button>
//                       </div>
//                     </div>
//                   </div>
//                 ))}
...
//                   <div key={request.id} className="p-4 border border-gray-100 rounded-2xl hover:shadow-md transition-all duration-300" >
//                     <h3 className="font-semibold text-gray-800 mb-1">{request.service}</h3>
//                     <p className="text-sm text-gray-600 mb-2">{request.provider}</p>
//                     <div className="flex items-center justify-between">
//                       <span className={`px-3 py-1 rounded-full text-xs font-medium ${request.status === "Completed" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}>
//                         {request.status}
//                       </span>
//                       {request.rating && (
//                         <div className="flex items-center"> <Star className="w-4 h-4 text-yellow-400 mr-1" /> <span className="text-sm font-medium">{request.rating}</span> </div>
//                       )}
//                     </div>
//                   </div>
//                 ))}
...
//             </div>
//             {/* Stats */}
//             <div className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-3xl p-6 text-white transform hover:shadow-xl transition-all duration-300">
//               <h2 className="text-xl font-bold mb-4">Your Stats</h2>
//               <div className="space-y-3">
//                 <div className="flex justify-between"> <span>Total Requests</span> <span className="font-bold">12</span> </div>
//                 <div className="flex justify-between"> <span>Completed</span> <span className="font-bold">10</span> </div>
//                 <div className="flex justify-between"> <span>Average Rating</span> <span className="font-bold">4.8</span> </div>
//               </div>
//             </div>
//           </div>
//         </div>
